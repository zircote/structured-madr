...
curl -o docs/decisions/0001-your-decision.md \
  https://raw.githubusercontent.com/modeled-information-format/structured-madr/main/templates/template.md
```
...
```bash
curl -o docs/decisions/0001-your-decision.md \
  https://raw.githubusercontent.com/modeled-information-format/structured-madr/main/templates/template-bare.md
```
