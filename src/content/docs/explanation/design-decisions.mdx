...
This page summarizes the architectural decisions that shaped Structured MADR. Each decision is documented as a formal ADR in the project's [`docs/decisions/`](https://github.com/modeled-information-format/structured-madr/tree/main/docs/decisions) directory, following the Structured MADR format itself (dogfooding).
