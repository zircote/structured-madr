...
The `mif-compliance` skill, the `/mif-validate` and `/mif-project` commands, the
...
Contributors who clone this repository are prompted to enable it automatically once
