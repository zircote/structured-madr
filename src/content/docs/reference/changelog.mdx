...
- [Unreleased changes](https://github.com/modeled-information-format/structured-madr/compare/v1.1.0...HEAD)
- [1.1.0 release](https://github.com/modeled-information-format/structured-madr/compare/v1.0.0...v1.1.0)
- [1.0.0 release](https://github.com/modeled-information-format/structured-madr/releases/tag/v1.0.0)
