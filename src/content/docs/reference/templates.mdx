...
**File:** [`templates/template.md`](https://github.com/modeled-information-format/structured-madr/blob/main/templates/template.md)
...
**File:** [`templates/template-bare.md`](https://github.com/modeled-information-format/structured-madr/blob/main/templates/template-bare.md)
...
# Bare template
curl -O https://raw.githubusercontent.com/modeled-information-format/structured-madr/main/templates/template-bare.md
```

### Using wget

```bash
wget https://raw.githubusercontent.com/modeled-information-format/structured-madr/main/templates/template.md
wget https://raw.githubusercontent.com/modeled-information-format/structured-madr/main/templates/template-bare.md
```
